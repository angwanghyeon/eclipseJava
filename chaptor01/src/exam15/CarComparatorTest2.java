...
public class CarComparatorTest2 {
	public static void main(String[] args) {
		...
		list.set(2, new Car("벤츠", 10, false, 220000));
		System.out.println(list); //이건 리스트
		cars = list.toArray(new Car[3]);
		System.out.println(Arrays.toString(cars)); //이건 배열
		
		Comparator<Car> ageComp = 
					modelComp.thenComparing(Car::getAge);
		Arrays.sort(cars, ageComp);
		System.out.println(Arrays.toString(cars));
	}
}
